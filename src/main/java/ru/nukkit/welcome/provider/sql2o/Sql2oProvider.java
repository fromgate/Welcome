...
public class Sql2oProvider implements PasswordProvider {

    // Players table queries

    public final static String createPlayersTable = "CREATE TABLE IF NOT EXISTS players (name VARCHAR NOT_NULL, password VARCHAR, PRIMARY KEY(name))";

    public final static String createLastloginTable = "CREATE TABLE IF NOT EXISTS lastlogin (name VARCHAR NOT_NULL, uuid VARCHAR NOT_NULL, ip VARCHAR NOT_NULL, time BIGINT NOT_NULL, PRIMARY KEY(name))";

    public final static String getPlayer = "SELECT * FROM players WHERE name = :name";

    public final static String setPassword = "INSERT OR REPLACE INTO players (:name, :password)";
    ...
    public final static String setLastlogin = "INSERT OR REPLACE INTO lastlogin (:name, :password, :uuid, :ip)";
